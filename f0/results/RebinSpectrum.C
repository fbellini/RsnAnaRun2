void RebinSpectrum(TH1F** hi,TH1F** hf,TF1* f,int n=1,int dofit=1,TH1F* ht=0){
  /* Author: Anders G. Knospe, The University of Texas at Austin
     ...
     TH1FF* hi[3];//input histogram array
     int n=3;//size of arrays hi and hf
     hi[0]=(TH1FF*) myfile->Get("measured_histogram_stat");//get your measured histogram with statistical uncertainties
     hi[1]=(TH1FF*) myfile->Get("measured_histogram_sys1");//get your measured histogram with first type of systematic uncertainties
     hi[2]=(TH1FF*) myfile->Get("measured_histogram_sys2");//get your measured histogram with second type of systematic uncertainties
     //expand the array as necessary to include as many types of systematic uncertainties as you need

     TH1FF* ht=(TH1FF*) hi[0]->Clone("ht");
     ...
     TH1FF* hf[2];//output (rebinned) histogram array
     hf[0]=new TH1FF("rebinned_stat","",nbins,bins);//will be filled with rebinned central values and statistical uncertainties (added in quadrature)
     hf[1]=new TH1FF("rebinned_sys1","",nbins,bins);//will be filled with rebinned central values and first type of systematic uncertainties (added linearly)
     hf[2]=new TH1FF("rebinned_sys2","",nbins,bins);//will be filled with rebinned central values and second type of systematic uncertainties (added linearly)
