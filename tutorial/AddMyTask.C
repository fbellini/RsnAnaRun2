...
AliAnalysisTaskMyTask* AddMyTask(TString name = "name") //DEFINISCO UNA FUNCTION
{
    ...
    fileName += ":MyTask";      // create a subfolder in the file COMODO
    ...
    return task; //RETURN A POINTER TO YOUR TASK (LINE USEFUL WHEN YOU DON'T USE YOUR LAPTOP!)
}
