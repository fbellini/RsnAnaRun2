...
void     RunGridRsnTrain(TString pluginmode="test", Short_t ntest = 1, TString suffix="Xe0414pidSysB",   Bool_t isLocalMerge = 0,
			 TString dataset = "LHC17n", Bool_t isMC = 0, Int_t aodN = -1,
			 TString username="fbellini", TString aliPhysicsVer = "vAN-20180406-1");
		     ...
		     TString username, TString aliPhysicsVer)
{
  ...
  if(useAlienPlugin) {
    ...
    //Order matters!!!!
    plugin->SetAdditionalLibs("liblhapdf.so libEGPythia6.so libpythia6.so libAliPythia6.so AddTaskPhiXeXeLight.C ConfigPhiXeXeLight.C AddMonitorOutput.C");
    ...
    //plugin->SetMaxInitFailed(25);
    plugin->SetMasterResubmitThreshold(10);
    plugin->SetTTL(50000);
    plugin->SetInputFormat("xml-single");
    if (isESD) plugin->SetSplitMaxInputFileNumber((isMC? 30 : 10));
    else plugin->SetSplitMaxInputFileNumber((isMC? 5 : 20));
  ...
  if (isMC) {
    ...
    taskMult->SetUseDefaultMCCalib(kTRUE);
    ...
    //Resonance task
    AliRsnMiniAnalysisTask* rsnAnaTask1 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(10, kTRUE)"));
    AliRsnMiniAnalysisTask* rsnAnaTask2 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(8, kTRUE)"));
    AliRsnMiniAnalysisTask* rsnAnaTask3 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(9, kTRUE)"));
    ...
    //Resonance task
    AliRsnMiniAnalysisTask* rsnAnaTask1 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(10, kFALSE)"));
    AliRsnMiniAnalysisTask* rsnAnaTask2 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(8, kFALSE)"));
    AliRsnMiniAnalysisTask* rsnAnaTask3 = reinterpret_cast<AliRsnMiniAnalysisTask*>(gInterpreter->ExecuteMacro("$HOME/alice/resonances/RsnAnaRun2/phiXeXe/steer/AddTaskPhiXeXeLight.C(9, kFALSE)"));
    ::Info("AnalysisSetup", "Setup successful");
  ...
  //Resonance task
  AliRsnMiniAnalysisTask * rsnAnaTask1 = (AliRsnMiniAnalysisTask*) AddTaskPhiXeXe(4, isMC);
  AliRsnMiniAnalysisTask * rsnAnaTask2 = (AliRsnMiniAnalysisTask*) AddTaskPhiXeXe(6, isMC);
  AliRsnMiniAnalysisTask * rsnAnaTask3 = (AliRsnMiniAnalysisTask*) AddTaskPhiXeXe(7, isMC);
