/***************************************************************************
fbellini@cern.ch - last modified on 20/02/2018
...
Bool_t ConfigPhiXeXeLight(AliRsnMiniAnalysisTask *task = 0x0, 
		     Bool_t                 isMC = kFALSE, 
		     TString                suffix = "",
		     ...
		     Bool_t                 checkReflex = kFALSE)
{
  ...
  Bool_t  use     [8] = {   !isMC,    !isMC,    0,    0,   isMC,    isMC,   0, 0};
