void dNdyAndMeanPt()
{
  ...
  const Short_t ncent = 4;
  TFile * file[nfunc];
  file[0] = TFile::Open("FITSPECTRUM_bgbw_0.5-10.0_09may18.root");
  file[1] = TFile::Open("FITSPECTRUM_boltz_0.5-10.0_09may18.root");
  file[2] = TFile::Open("FITSPECTRUM_fermi_0.5-10.0_09may18.root");
  file[3] = TFile::Open("FITSPECTRUM_levy_0.5-10.0_09may18.root");
  file[4] = TFile::Open("FITSPECTRUM_mtexp_0.5-10.0_09may18.root");
