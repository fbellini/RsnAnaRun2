...
void MeanPt(Bool_t plotPbPb = 1, Bool_t plotBayes = 1, Bool_t plotKstar = 0)
{
  ...
  TFile *filephi_Xe = TFile::Open("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/final/results/Phi_MeanPt_XeXe544TeV.root");
  TGraphErrors * gPhi_meanPT_XeXe5TeV_stat = (TGraphErrors*)filephi_Xe->Get("phi_meanpt_XeXe544TeV_stat");
  TGraphErrors * gPhi_meanPT_XeXe5TeV_syst = (TGraphErrors*)filephi_Xe->Get("phi_meanpt_XeXe544TeV_syst");
  ...
  */
  TFile *fileks = TFile::Open("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/preliminaryQM18/PbPb5TeV/MeanPt/FinalKStardNdYMeanPtV0MNew.root");
  ...
  TFile *filephi = TFile::Open("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/preliminaryQM18/PbPb5TeV/MeanPt/FinalPhidNdYMeanPtV0MNew.root");
  ...
  TFile *f5TeV = TFile::Open("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/preliminaryQM18/PbPb5TeV/MeanPt/YieldAndMeanPtPbPb5TeV.root");
  f5TeV->ls();
  ...
  l1->SetBorderSize(0);
  l1->SetFillStyle(0);
  l1->AddEntry((TObject*)0,"#bf{ALICE}","");
  l1->AddEntry((TObject*)0,"Pb-Pb #sqrt{#it{s}_{NN}} = 5.02 TeV (open markers, PREL)","");
...
{
  TString XeFileName = Form("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/final/piKp/YieldAndMeanPtSum%swSys_2020.root", part.Data());
...
TGraph * GetBayesPredictionsMeanPt_PbPb502TeV(TString particle)
{
  /****************************************
   ...
   //Data from
   //****************************************/
  TFile * fBayes = TFile::Open(Form("/Users/fbellini/alice/resonances/RsnAnaRun2/phiXeXe/preliminaryQM18/Bayesian/PbPb5020/BayesianPredictionMeanPt%s.root", particle.Data()));
