/***************************************************************************
fbellini@cern.ch - last modified on 14/04/2020

Macro to add monitoring histograms for track and PID cuts to the rsn task 
Tuned for monitoring cuts for phi analysis with 2017 XeXe data
...
void AddMonitorOutputPhiXeXe(Bool_t useMCMon = 0, TObjArray *mon=0,TString opt="NoSIGN", AliRsnLoopDaughter *lm=0);

void AddMonitorOutputPhiXeXe(Bool_t useMCMon, TObjArray *mon,TString opt, AliRsnLoopDaughter *lm)
{
  //Set options
