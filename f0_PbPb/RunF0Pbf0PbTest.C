...
// include path
   ...
   gSystem->AddIncludePath("-I. -I$ROOTSYS/include -I$ALICE_ROOT/include -I$ALICE_PHYSICS/include -I$ALICE_PHYSICS/OADB/ -I$ALICE_PHYSICS/OADB/COMMON -I$ALICE_PHYSICS/OADB/COMMON/MULTIPLICITY -g ");
...
// analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliRsnMiniAnalysisTaskV2.cxx+g");

// read the analysis manager from file
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("RunF0Pbf0PbTest.root");
   if (!mgr) return;
   mgr->PrintStatus();
